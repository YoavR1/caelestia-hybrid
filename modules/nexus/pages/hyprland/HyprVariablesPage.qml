...
PageBase {
    ...
    ColumnLayout {
        ...
        FloatRow {
            label: "Scroll factor"
            varKey: "touchScrollFactor"
        }
        IntRow {
            label: "Gesture fingers"
            varKey: "gestureFingers"
            from: 1
            to: 10
        }
        IntRow {
            label: "Workspace swipe fingers"
        ...
        IntRow {
            label: "Window gaps in"
            varKey: "windowGapsIn"
            from: 0
            to: 100
        }
        IntRow {
            label: "Window gaps out"
        ...
        StringRow {
            label: "Active window border colour"
            varKey: "activeWindowBorderColour"
        }
        StringRow {
            last: true
            label: "Inactive window border colour"
